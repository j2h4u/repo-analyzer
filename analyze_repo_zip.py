#!/usr/bin/env python3
"""Repository analyzer with Gemini API integration."""
...
from repo_analyzer.core import (
    scan_zip,
    GeneratedFile,
...
# --- 3. CORE LOGIC ---
# Note: Pure core functions moved to repo_analyzer.core:
#   - scan_zip() → core/scanner.py
#   - parse_generated_files(), resolve_file_conflicts() → core/file_parser.py
#   - GeneratedFile dataclass → core/file_parser.py
